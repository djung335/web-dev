        ...
        <table style={{marginBottom: '16px'}}>
          <tr>
            ...
            <td style={{width: "100%"}}>
              ...
              <span>
                            <a href="image.html"><i
                                className="far fa-image me-3"></i></a>
                            <a href="analytics.html"><i
                                className="far fa-analytics me-3"></i></a>
                            <a href="smile.html"><i
                                className="far fa-smile me-3"></i></a>
                            <a href="calendar.html"><i
                                className="far fa-calendar me-3"></i></a>
                        </span>
